...
export default function Table_2_1_Fito({ posts, patch, destroy, setData }) {
    ...
    const columns = useMemo(
        () => [
            {
                header: '2.1 DATOS IDENTIFICATIVOS Y AGRONÓMICOS DE LAS PARCELAS',                   
                columns: [
                    {
                        accessorKey: "id",
                        header: "Nº orden",
                    ...
                    {
                        header:'REFERENCIAS SIGPAC',
                        columns:[
                            {
                                accessorKey: "codigo_prov",
                            ...
                            {
                                accessorKey: "codigo_ag",
                                header: "Código agregado",                                
                                size: 120,
                                Cell: ({ renderedCellValue }) => <span>{renderedCellValue}</span> //optional custom cell render
                            },
                            {
                    ...
                    {
                        header:'DATOS AGRONÓMICOS',
                        columns:[
                            {
                                accessorKey: "su_cultivada",
                                header: "Superficie cultivada (ha)",
                                size: 80,
                                Cell: ({ renderedCellValue }) => <span>{renderedCellValue}</span>, //optional custom cell render
                            ...
                            {
                                accessorKey: "secano",
                                header: "Secano/Regadío",
                                size: 80,
                                Cell: ({ renderedCellValue }) => <span>{renderedCellValue}</span> //optional custom cell render
                            },
                            {
                                accessorKey: "aire_libre",
                                header: "Aire libre/protegido",
                                size: 80,
                                Cell: ({ renderedCellValue }) => <span>{renderedCellValue}</span> //optional custom cell render
                            },                           
                        ]
                    ...
                    {
                        header: "Sistema de asesoramiento en gestión integrada de plagas",
                        accessorKey: "sistema",
                        editVariant:'select',                        
                        size: 150,
                        Cell: ({ renderedCellValue }) => <span>{renderedCellValue}</span>, //optional custom cell render
